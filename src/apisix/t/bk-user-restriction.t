...
=== TEST 2: add route with whitelist
--- config
    location /t {
        content_by_lua_block {
...
=== TEST 4: add route with whitelist but unknown user
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
=== TEST 6: add route with blacklist
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
...
=== TEST 8: add route with blacklist but unknown user
--- config
    location /t {
        content_by_lua_block {
            local t = require("lib.test_admin").test
