...
local plugin = require("apisix.plugins.bk-global-rate-limit")
local ratelimit = require("apisix.plugins.bk-rate-limit.init")

describe(
    "bk-global-rate-limit", function()
        ---@type apisix.Context
        local ctx
        local conf
        ...
        it(
            "should check schema", function()
                ...
                assert.is_equal(plugin.name, "bk-global-rate-limit")
        ...
        it(
            "should do nothing when config is disabled", function()
                conf.enabled = false
