...
[![license](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat)](https://github.com/TencentBlueKing/blueking-apigateway-apisix/blob/main/LICENSE.txt) [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/TencentBlueKing/blueking-apigateway-apisix/pulls)
...
This project is the "BlueKing API Gateway - Data Plane".
...
- High performance: developed based on the APISIX gateway as the foundation (component).
- Scalable: leveraging the plugin mechanism to extend support for BlueKing application authentication, user authentication, IP access control, rate limit, access logs, integration with OpenTelemetry, and more.
